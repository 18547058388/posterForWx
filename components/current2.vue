	...
	export default {
		data() {
			return {
				...
				kindlist: [{
						title: "早安",
						src:require('../static/image/21.jpg')
						
					},
					{
						title: "晚安",
						src:require('../static/image/22.jpg')
					},
					{
						title: "日签",
						src:require('../static/image/23.jpg')
					},
					{
						title: "月签",
						src:require('../static/image/24.jpg')
					},
					{
						title: "晒图",
					...
					{
						title: "情感",
						src:require('../static/image/26.jpg')
					},
